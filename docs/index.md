...
## 🏗️ Proyectos Técnicos

- 🔹 [Arquitectura](proyecto-arquitectura.md)  
  Tipologías T1, T2 y T3, materiales, diseño modular y criterios de implantación.

- 🔹 [Accesibilidad](proyecto-accesibilidad.md)  
  Adaptación universal según normativa española, soluciones técnicas y entorno accesible.

- 🔹 [Estabilidad estructural](proyecto-estabilidad.md)  
  Cálculo y justificación técnica para madera laminada y hormigón armado.

- 🔹 [Costes comparativos](costo-madera-vs-hormigon.md)  
  Análisis económico y ambiental entre sistemas constructivos.

---

## 🏘️ Tipologías de Vivienda

- 🏠 [T1 – 55 m²](arquitectura/t1.md)  
- 🏠 [T2 – 80 m²](arquitectura/t2.md)  
- 🏠 [T3 – 120 m²](arquitectura/t3.md)
...
## 🗣️ Participación y Comunicación

- 🧑‍🤝‍🧑 [Participación ciudadana](participacion-ciudadana.md)  
- 🎨 [Comunicación visual](comunicacion-visual.md)  
...
> “Diseñamos hogares que respetan la tierra, las personas y el futuro compartido.”
